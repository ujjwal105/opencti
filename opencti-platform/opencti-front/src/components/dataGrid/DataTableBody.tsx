...
import { ColumnSizeVars, DataTableBodyProps, LocalStorageColumns } from './dataTableTypes';
...
const DataTableBody = ({
  ...
  const { resolvePath, storageKey, setColumns, useDataTable, useDataTableLocalStorage } = useContext(DataTableContext);
