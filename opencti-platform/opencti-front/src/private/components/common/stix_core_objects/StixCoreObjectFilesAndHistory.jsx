  ...
  mutation StixCoreObjectFilesAndHistoryExportMutation(
    ...
    stixDomainObjectEdit(id: $id) {
      exportAsk(
        ...
        fileMaxMarkings: $fileMaxMarkings
      ) {
        id
        name
        uploadStatus
...
const exportValidation = (t_i18n) => Yup.object().shape({
  ...
  fileMaxMarkingDefinitions: Yup.array().min(1, 'This field is required').required(t_i18n('This field is required')),
});
